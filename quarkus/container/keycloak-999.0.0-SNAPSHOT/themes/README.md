...
a reference. These can be found within the theme directory of `../lib/lib/main/org.keycloak.keycloak-themes-999.0.0-SNAPSHOT.jar`, which can be opened using any
